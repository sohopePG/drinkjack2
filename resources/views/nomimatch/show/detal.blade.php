    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="md:p-2 p-1 bg-white border-b border-gray-200">
                        ...
                        @foreach ($recruitment->participants as $participant)
                            <div class="flex-col px-3 py-5 flex justify-between">
                                <a href="{{ route('nomimatch.user_detail', $participant->profile) }}"
                                    class="text-lg font-medium hover:underline">
                                    <img src="{{ Storage::disk('s3')->url($participant->user->profile->image) }}"class="w-16 h-16 md:w-36 md:h-36 mx-auto"
                                        class="my-auto">
                                ...
                                <div class="p-4">
                                    <div class="flex justify-between relative">
                                        <div class="flex items-center">
                                            <img src="{{ Storage::disk('s3')->url($comment->user->profile->image) }}"
